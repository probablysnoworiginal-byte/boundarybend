        ...
        dangerouslySetInnerHTML={{
          ...
          if (typeof fetchData !== "undefined") {
            fetchData.then(function(index) {
              ...
              var lowered = cleanPathname.toLowerCase();
              var slug = lowered !== cleanPathname && index[lowered] != null ? lowered : cleanPathname;
              if (index[slug] != null && !pathname.endsWith(".html")) {
                var prefix = hasBasePrefix ? basePath : "";
                var target = prefix + (prefix.endsWith("/") ? "" : "/") + slug + ".html" + window.location.hash;
